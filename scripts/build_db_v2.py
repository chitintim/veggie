...
# ============================================================
# v3 ADDITIONS BATCH 2 — hotels + underrepresented cuisines
# ============================================================

A_NEW3 = [
    {"Name (EN)": "Tsz Shan Monastery Vegetarian Hall", "Name (中文)": "慈山寺素食堂", "Sub-type": "Buddhist monastery 齋 (complimentary)", "District": "Tai Po", "Address": "Universal Gate Rd, Tai Po", "Phone": "+852 2123 8666", "Website / IG": "tszshan.org", "Booking": "Online registration required (advance)", "Hours": "Lunch ~12:00; refreshments 13:30–16:30", "Price (HKD/pp)": "Complimentary (with monastery visit)", "Veg type": "Buddhist 齋 (no allium, vegan)", "Jain": "Yes (de facto)", "Signature / sample dishes (with prices where known)": "Set vegetarian lunch (rice + 4 dishes); buns; pu-erh tea", "Google rating": "—", "OpenRice rating": "—", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Localiiz feature", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Inside the working monastery. Online registration required (slots open 8am daily). Strict no-meat/no-alcohol on premises. One of HK's serenest temple-meal experiences.", "Sources (URLs)": "https://tszshan.org; Localiiz"},
]

C_NEW3 = [
    {"Name (EN)": "One Harbour Road", "Name (中文)": "港灣壹號", "Sub-type": "Cantonese fine dining", "District": "Wan Chai (Grand Hyatt)", "Address": "7-8/F, Grand Hyatt HK, 1 Harbour Rd, Wan Chai", "Phone": "+852 2588 1234", "Website / IG": "hongkong.grand.hyattrestaurants.com", "Booking": "OpenTable, phone", "Hours": "12:00–15:00; 18:00–22:30", "Price (HKD/pp)": "500–1,200", "Veg type": "Mixed; dedicated vegetarian tasting", "Jain": "On request", "Signature / sample dishes (with prices where known)": "Omnipork dumplings; stir-fried lotus root w/ plant-based protein; seasonal veg dim sum; veg double-boiled soup", "Google rating": "—", "OpenRice rating": "4.3", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Michelin Selected", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Pre-order veg tasting with notice. Two-storey Cantonese pavilion overlooking the harbour.", "Sources (URLs)": "https://www.hongkong.grand.hyattrestaurants.com"},
    {"Name (EN)": "Yat Tung Heen", "Name (中文)": "逸東軒", "Sub-type": "Cantonese fine dining", "District": "Jordan (Eaton HK)", "Address": "B2/F, Eaton HK, 380 Nathan Rd, Jordan", "Phone": "+852 3956 0188", "Website / IG": "yattungheen.com", "Booking": "OpenTable, phone", "Hours": "11:00–15:00; 17:30–23:00", "Price (HKD/pp)": "400–1,100", "Veg type": "Mixed; vegetarian set menu on request", "Jain": "On request", "Signature / sample dishes (with prices where known)": "Vegetable-forward dim sum, tofu sets, seasonal veg, mushroom hot pot", "Google rating": "—", "OpenRice rating": "4.4", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "★ Michelin (multi-year)", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "1920s-inspired interior. Pre-book the veg set.", "Sources (URLs)": "https://www.yattungheen.com"},
    {"Name (EN)": "Petrus", "Name (中文)": "—", "Sub-type": "Contemporary French fine dining", "District": "Admiralty (Island Shangri-La)", "Address": "56/F, Island Shangri-La, Pacific Place, 88 Queensway, Admiralty", "Phone": "+852 2877 3838", "Website / IG": "shangri-la.com/hongkong/islandshangrila", "Booking": "OpenTable, phone", "Hours": "Dinner 17:30–22:30 (Tue-Sun)", "Price (HKD/pp)": "650–1,400", "Veg type": "Vegetarian 5-course tasting on request", "Jain": "On request", "Signature / sample dishes (with prices where known)": "Beetroot tortellini; vegetable mains; produce-led seasonal courses", "Google rating": "—", "OpenRice rating": "4.4", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "★★ Michelin", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Notify in advance for the veg tasting. Victoria Harbour views from the 56th floor.", "Sources (URLs)": "https://www.shangri-la.com/hongkong/islandshangrila"},
    {"Name (EN)": "Nicholini's", "Name (中文)": "—", "Sub-type": "Northern Italian", "District": "Admiralty (Conrad HK)", "Address": "8/F, Conrad HK, Pacific Place, 88 Queensway, Admiralty", "Phone": "+852 2822 8366", "Website / IG": "conraddining.com/en/nicholinis", "Booking": "OpenTable", "Hours": "12:00–14:30; 18:00–23:00", "Price (HKD/pp)": "350–850", "Veg type": "Mixed; substantial pasta + vegetable-centric dishes", "Jain": "Limited", "Signature / sample dishes (with prices where known)": "Handcrafted pasta (mushroom, truffle); seasonal vegetable mains; antipasti veg plates", "Google rating": "—", "OpenRice rating": "4.3", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Tatler-listed", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Long-running Italian institution at Conrad. Pasta-heavy means strong veg.", "Sources (URLs)": "https://conraddining.com"},
    {"Name (EN)": "Sing Yin Cantonese Dining", "Name (中文)": "星宴", "Sub-type": "Cantonese / dim sum", "District": "Tsim Sha Tsui (W Hong Kong)", "Address": "1/F, W Hong Kong, 17 Hanoi Rd, TST", "Phone": "+852 3717 2232", "Website / IG": "—", "Booking": "OpenTable", "Hours": "11:30–15:00; 18:00–23:00", "Price (HKD/pp)": "350–700", "Veg type": "Mixed; substantial veg dim sum + à la carte", "Jain": "On request", "Signature / sample dishes (with prices where known)": "Steamed tomato w/ mushroom; braised bean curd sheet w/ morels; imperial fungus soup", "Google rating": "—", "OpenRice rating": "4.0", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Tatler-listed", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Modern Cantonese with a creative veg dim sum slate.", "Sources (URLs)": "OpenTable; Tatler Asia"},
    {"Name (EN)": "Asaya Kitchen", "Name (中文)": "—", "Sub-type": "Mediterranean / Japanese wellness", "District": "Tsim Sha Tsui (Rosewood)", "Address": "6/F, Rosewood HK, Victoria Dockside, 18 Salisbury Rd, TST", "Phone": "+852 8129 7888", "Website / IG": "rosewoodhotels.com/hong-kong/dining/asaya-kitchen", "Booking": "OpenTable, phone", "Hours": "06:00–23:00", "Price (HKD/pp)": "300–700", "Veg type": "Substantial plant-based + dedicated vegan section", "Jain": "On request", "Signature / sample dishes (with prices where known)": "Buddha bowls; vegetable miso; seasonal plant plates; cold-pressed juices", "Google rating": "—", "OpenRice rating": "4.2", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Wellness guide features", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Inside Rosewood's Asaya wellness facility. Sustainability + wellness focus.", "Sources (URLs)": "https://www.rosewoodhotels.com/en/hong-kong/dining/asaya-kitchen"},
    {"Name (EN)": "GREEN", "Name (中文)": "—", "Sub-type": "International brasserie (vertical garden)", "District": "Tsim Sha Tsui East (Hotel ICON)", "Address": "Hotel ICON, 17 Science Museum Rd, TST East", "Phone": "+852 3400 0678", "Website / IG": "hotel-icon.com/dining/green", "Booking": "OpenTable", "Hours": "Breakfast 06:30–11:00; Lunch 11:00–17:00; Dinner 17:00–23:00", "Price (HKD/pp)": "200–500", "Veg type": "Mixed; explicit vegetarian + vegan sections", "Jain": "Limited", "Signature / sample dishes (with prices where known)": "Impossible burger ($168); seasonal vegetables; plant-based mains; brunch veg plates", "Google rating": "—", "OpenRice rating": "4.0", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Featured in HK vegan guides", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Massive vertical garden interior. Casual, brunch-friendly. Easy reservation.", "Sources (URLs)": "https://www.hotel-icon.com/dining/green"},
]

D_NEW3 = [
    {"Name (EN)": "An Choi", "Name (中文)": "—", "Sub-type": "Vietnamese (banh mi + phở)", "District": "Sheung Wan", "Address": "15-17 Mercer St, Sheung Wan", "Phone": "+852 5286 1517", "Website / IG": "@anchoihk", "Booking": "Walk-in", "Hours": "12:00–22:00 (varies)", "Price (HKD/pp)": "100–180", "Veg type": "Mixed; banh mi & pho can be ordered veg", "Jain": "Limited", "Signature / sample dishes (with prices where known)": "Vegetarian banh mi (tofu / mushroom); phở chay (vegetable broth); summer rolls; bún with veg", "Google rating": "—", "OpenRice rating": "4.0", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Michelin Bib Gourmand", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Naturally veg-friendly Vietnamese — most dishes can be made veg on request.", "Sources (URLs)": "Michelin Guide HK"},
    {"Name (EN)": "Brass Spoon", "Name (中文)": "—", "Sub-type": "Vietnamese (build-your-own pho)", "District": "Wan Chai (+ multi-branch)", "Address": "G/F, 1 Moon St, Wan Chai (also TST, Causeway Bay, Sheung Wan)", "Phone": "—", "Website / IG": "brassspoonhk.com", "Booking": "Walk-in", "Hours": "11:30–22:00", "Price (HKD/pp)": "100–160", "Veg type": "Mixed; veg pho with tofu / build-your-own bowl", "Jain": "Limited", "Signature / sample dishes (with prices where known)": "Veg phở with tofu + mushroom; banh mi (no meat); summer rolls", "Google rating": "—", "OpenRice rating": "4.0", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Michelin Bib Gourmand", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Build-your-own pho lets you skip meat. Multiple HK branches.", "Sources (URLs)": "Michelin Guide HK; brassspoonhk.com"},
    {"Name (EN)": "Serendib", "Name (中文)": "錫蘭地", "Sub-type": "Sri Lankan", "District": "Sheung Wan", "Address": "148 Wing Lok St, Sheung Wan", "Phone": "—", "Website / IG": "—", "Booking": "Phone, OpenRice", "Hours": "Lunch + dinner (verify)", "Price (HKD/pp)": "120–180", "Veg type": "Mixed; dedicated veg section (substantive)", "Jain": "Partial", "Signature / sample dishes (with prices where known)": "Veg samosas; deviled chickpeas; veg kottu; hoppers (egg + plain); coconut sambol", "Google rating": "—", "OpenRice rating": "4.0", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "—", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "One of HK's only Sri Lankan restaurants. Naturally veg-heavy cuisine.", "Sources (URLs)": "OpenRice"},
    {"Name (EN)": "Hotal Colombo", "Name (中文)": "—", "Sub-type": "Sri Lankan", "District": "Soho (Central)", "Address": "31 Elgin St, Soho, Central", "Phone": "—", "Website / IG": "blacksheeprestaurants.com/restaurants/hotal-colombo", "Booking": "SevenRooms", "Hours": "Lunch + dinner (verify)", "Price (HKD/pp)": "180–280", "Veg type": "Mixed; strong veg dosa / kottu / curry section", "Jain": "Partial", "Signature / sample dishes (with prices where known)": "Veg dosa; veg kottu; hoppers (string + plain); pol sambol; potato curry", "Google rating": "—", "OpenRice rating": "4.1", "HappyCow rating": "—", "Michelin / Tatler / Time Out": "Tatler-listed", "Review-quality flag": "Trusted", "Operational status": "Open", "Notes": "Black Sheep Restaurants. Sri Lankan diner-style.", "Sources (URLs)": "https://blacksheeprestaurants.com"},
]

CAT_A = list(CAT_A_BASE) + A_NEW + A_NEW2 + A_NEW3
CAT_B = list(CAT_B_BASE) + B_NEW + B_NEW2
CAT_C = list(CAT_C_BASE) + C_NEW + C_NEW2 + C_NEW3
CAT_D = list(CAT_D_BASE) + D_NEW + D_NEW2 + D_NEW3 + CLOSED_REF
