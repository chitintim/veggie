...
// Click anywhere on the handle button to toggle
...
drawerHandle.addEventListener("touchend", () => { dragStartY = null; });

// Header is also tappable as a backup
